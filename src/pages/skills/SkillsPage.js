  ...
  return (
    <div className="pt-3 pb-3" id="skills">
      ...
      <CardColumns  >
        ...
        <SkillTemplate title='Programing Languages' skillSet={skills.programmingLanguages} />
        <SkillTemplate title='Version Control' skillSet={skills.versionControl} />
        <SkillTemplate title='Hosting Platforms' skillSet={skills.hostingPlatforms} />
